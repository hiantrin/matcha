			...
			<div className='w-full h-full flex flex-col justify-center items-center lg:flex-row'>
				<div className='sm:w-[80%] h-full lg:w-[50%] flex flex-col justify-center items-center lg:items-start order-last lg:order-first '>
					...
					<div className='max-w-[350px] h-[30px] rounded-xl bg-gray-200 flex justify-center pl-3  left-shadow'>
						<input type="text" autoComplete="off" name="username" placeholder='username to connect' className='w-[250px] sm:w-[350px] bg-transparent outline-none  placeholder:text-[0.7rem] font-bold' value={formValues.username} onChange={handlechange}></input>
					</div>
					...
					<div className='max-w-[350px] h-[30px] rounded-xl bg-gray-200 flex justify-center pl-3  left-shadow'>
						<input type="password" autoComplete="off" name="password" placeholder='at least 8 characters' className='w-[250px] sm:w-[350px] bg-transparent outline-none  placeholder:text-[0.7rem] font-bold' value={formValues.password} onChange={handlechange}></input>
					</div>
					...
					<button className='w-[250px] sm:w-[350px] h-[30px] text-xs font-bold'>Login in</button>
