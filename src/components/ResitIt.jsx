			...
			<div className='w-full h-full flex flex-col justify-center items-center lg:flex-row'>
				<div className='sm:w-[80%] h-full lg:w-[50%] flex flex-col justify-center items-center lg:items-start order-last lg:order-first'>
					...
					<div className='max-w-[350px] h-[30px] rounded-xl bg-gray-200 flex justify-center px-3  left-shadow '>
						<input type="text" name="password" placeholder='New Password' className='w-[250px] sm:w-[350px] bg-transparent outline-none  placeholder:text-[0.7rem] font-bold' value={infos.newPassword} onChange={(e) => handleChange(e, 1)}></input>
					</div>
					<p   className='text-red-600 text-xs mb-6 ml-3 '>{errors.newPassword}</p>
					<div className='max-w-[350px] h-[30px] rounded-xl bg-gray-200 flex justify-center px-3  left-shadow'>
						<input type="text" name="confirmPassword" placeholder='New Password' className='w-[250px] sm:w-[350px] bg-transparent outline-none  placeholder:text-[0.7rem] font-bold' value={infos.confNewPassword} onChange={(e) => handleChange(e, 2)}></input>
					</div>
